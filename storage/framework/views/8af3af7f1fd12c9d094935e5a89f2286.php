            ...
            <div class="p-5 rounded-3 col-xl-4 border" style="background-color:rgb(255,188,224)">
                ...
                <div class="row">
                    <div class="col-md-12 d-grid">
                        <a href="<?php echo e(route('employees.index')); ?>" class="btn btn-outline-danger btn-lg mt-3"><i class="bi-arrow-left-circle me-2"></i> Back</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PraktikumGitKelompok\resources\views/employee/show.blade.php ENDPATH**/ ?>